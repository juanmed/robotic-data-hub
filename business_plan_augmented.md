...
**Official manufacturing base**
- Statistics Korea’s preliminary 2023 Census on Establishments reported **532,325 manufacturing establishments** in South Korea.
...
Because no official Korean statistic directly publishes “high-mix / low-volume packing or kitting lines addressable by two small robot arms,” the following is a **modeling assumption**, not an official published figure:

- Assume **5%** of Korea’s manufacturing establishments fall into the initial workflow archetype.  
  - 532,325 × 5% = **26,616 candidate establishments**.

This is intentionally conservative as a first pass, and should be refined with sector-specific KOSIS cuts in food, cosmetics, light consumer goods, and electronics packaging.
...
Using the 5% candidate-establishment assumption:

- **Korea workflow TAM / SAM (initial):** 26,616 candidate establishments
- **Base recurring revenue opportunity:** 26,616 × KRW 24M ≈ **KRW 638.8B / year**
- **Upper recurring case:** 26,616 × KRW 30M ≈ **KRW 798.5B / year**

This is the practical **Korea-first recurring revenue opportunity** for the beachhead workflow before adding one-time deployment revenue.
...
That implies:
- **Year 5 site share:** 70 / 26,616 = **0.26%** of modeled candidate Korean establishments
...
At higher adoption, this expands quickly.

**Conclusion:** the global platform TAM is likely large enough to matter, but the company should **not** raise money on a speculative global marketplace story alone. It should raise on the Korea services wedge that creates the proprietary assets needed to earn that platform upside.
...
- **Target service fee:** **KRW 12M–25M** per line/workcell
